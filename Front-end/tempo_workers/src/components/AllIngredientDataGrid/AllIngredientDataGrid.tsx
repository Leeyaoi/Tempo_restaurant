...
const AllIngredientDataGrid = ({
    ...
    const { updateIngredient, fetchCategory, Category } = useGlobalStore();
    ...
    return (
        <>
            ...
            <Dialog open={openDelete} onClose={handleCloseDelete}>
                ...
                <DialogContent>
                    <p>Вы уверены, что хотите удалить этого ингредиента?</p>
                </DialogContent>
                <DialogActions>
...
export default AllIngredientDataGrid;
